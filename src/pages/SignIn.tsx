      ...
      <main className="flex-grow pt-24 pb-16 px-4 sm:px-6 lg:px-8 dark:bg-gray-900">
        <div className="max-w-md mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-8">
          <div className="text-center mb-6">
            ...
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Sign in to GreenAudit</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Link to="/reset-password" className="text-sm text-green-600 dark:text-green-500 hover:text-green-800 dark:hover:text-green-400">
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
            ...
            <div className="text-center text-sm text-gray-600 dark:text-gray-400">
              ...
              <Link to="/signup" className="font-medium text-green-600 dark:text-green-500 hover:text-green-800 dark:hover:text-green-400">
                Create an account
              </Link>
            </div>
          </form>
